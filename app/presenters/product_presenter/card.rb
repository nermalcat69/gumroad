...
class ProductPresenter::Card
  ...
  def for_web(request: nil, recommended_by: nil, recommender_model_name: nil, target: nil, show_seller: true, affiliate_id: nil, query: nil, from_taxonomy: nil)
    default_recurrence = product.default_price_recurrence
    {
      ...
      url: url_for_product_page(product, request:, recommended_by:, recommender_model_name:, layout: target, affiliate_id:, query:, from_taxonomy:),
